  ...
  return (
    <div className="min-h-screen gradient-bg p-4 sm:p-6 md:p-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        <article className="prose prose-base sm:prose-lg lg:prose-xl dark:prose-invert max-w-4xl">
          <h1 className="workspace-title mb-8">
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              And vice versa. However, setting up a finite, albeit imperfect set of rules helps us manage infinitely
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed text-foreground">
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              Rules" would have a similar depth, weight and impact. I love the idea of putting thoughts "to paper",
              sharing them and letting things take shape. I hoped to benefit by becoming a better person for those
              around me, but I also have in mind an audience. Family and friends, primarily. The name "Number One Rules"
              comes from a running joke we had with the team at work. Whenever someone would make a mistake, the comment
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              nothing is lost. I would be absolutely delighted to see the rules of every person I've collaborated with
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              find - you don't intend to learn it by heart and apply it dogmatically. You hope to discover a few things
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed text-foreground">
              ...
              But while in its prime, it was often referred to as the hidden gem. A cause for many locals to reignite
              their belief that there's an alternative to the "kiss up, kick down" attitude traditionally and lazily
              perceived the only possibility in a Balkan company. And a cause for many non-Balkan clients and partners
              to rediscover value and humanity where perhaps they'd not expect it. From beginning to end, I'm willing to
              argue it was living proof that a strong moral compass doesn't come at a cost of success. Which, I guess,
              depends on any single person's definition, but this is exactly the type of discussion I would enjoy having
              with you.
            </p>
          </section>
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              species' self-destructive tragicomic exit from meaningful existence. While I certainly joined following
              the news and the possibilities accompanying AI tools, the main question I kept asking was how the hell
              will this influence us sense of being human, mostly with each other. Drawing an analogy between the AI
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-4 text-foreground">
              ...
              foreseeable beginning. Reality distortion mechanisms already in play will get supercharged, governments
              and regulatory systems will be vastly unprepared, other ongoing crises like global warming and major
              conflicts are likely too exacerbate as the focus shifts to the inevitable AI arms race. What do we do as
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed text-foreground">
              ...
              to the purpose of the rules. Conversely, the generative AI used on the website is more than simply
              informed by the Number One Rules - it's also bounded by patterns of thinking built as safeguards,
              imperfect as they may be, ensuring an ethical and empathetic approach. A "bounded rationality" which is
              limited, but good enough. Oh, by the way: all content of the "Number One Rules" is human generated. AI, if
              used, will be only to help usability and accessibility of the content, not creating or changing it beyond
              a rudimental spellcheck. That's for us humans to do, while we still can.
            </p>
          </section>
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-2 text-foreground">Perfec™ is:</p>
            <ul className="list-disc pl-6 text-base sm:text-lg leading-relaxed sm:leading-relaxed space-y-2 text-foreground">
              ...
              <li>
                the acceptance of being alive as our once in a lifetime opportunity to contribute to something greater
                than ourselves
              </li>
