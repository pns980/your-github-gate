      ...
      <div className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-base sm:prose-lg lg:prose-xl dark:prose-invert max-w-none">
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed sm:leading-loose mb-4">
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed sm:leading-loose">
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed sm:leading-loose mb-2">Perfec™ is:</p>
            <ul className="list-disc pl-6 text-muted-foreground text-base sm:text-lg leading-relaxed sm:leading-loose space-y-2">
