...
const RulesBrowser = () => {
  ...
  return <div className="min-h-screen gradient-bg p-4 sm:p-6 md:p-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Filters Card */}
        <div className="workspace-panel p-4 sm:p-6 md:p-8 mb-8 sm:mb-10 border border-border ">
        ...
        {/* Rules Grid */}
        <div id="rules-grid">
          {filteredRules.length === 0 ? <div className="text-center text-muted-foreground text-xl sm:text-2xl mt-10 sm:mt-20 p-6 sm:p-10 workspace-panel border border-border">
            ...
            return <div key={index} className="workspace-panel p-4 sm:p-6  border border-border transition-all hover:shadow-lift flex flex-col">
